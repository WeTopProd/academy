import { DisciplinesTypes, type, resize } from '../../../types/DisciplinesType';
export const disciplineSeed = [
  {
    ...
    ImageType: '.png',
    description:
      'Веб-дизайнер занимается созданием визуальных концепций для различных видов веб-страниц, включая лендинги, сайты компаний и интернет-магазины. Он также создает дизайн интерфейсов для интернет-сервисов и мобильных приложений, а также разрабатывает шаблоны для электронных рассылок и интернет-баннеров.',
  ...
  },
  {
    ...
    ImageType: '.png',
    description:
      'Ведущий мероприятия осуществляет контакт с приглашенными гостями, генерирует и удерживает настроение, организует конкурсы и развлечения для аудитории. Он проводит активные развлекательные программы, шоу и презентации, присматривает за гостями, координирует музыкальное сопровождение мероприятий.',
    lesson_duration: '1,5 часа',
  ...
  },
  {
    ...
    ImageType: '.png',
    description:
      'Танец степ - это особый стиль танца, который характеризуется использованием стоп, пяток и пальцев ног для создания ритмичных звуков и мелодичных паттернов. Танец степ является не только творческим и энергичным искусством, но и физически активным занятием, требующим силы, гибкости, координации и музыкальности.',
  ...
  },
  {
    ...
    ImageType: '.png',
    description:
      'Вокал - это искусство пения, использования голоса в музыкальных произведениях или других вокальных выступлениях. Занятия вокалом могут включать различные аспекты, такие как техника дыхания, подготовка голоса, развитие музыкального слуха, исполнение разных стилей музыки, интерпретация текстов и многое другое.',
    lesson_duration: '1 час',
    skills: [
  ...
  },
  {
    ...
    ImageType: '.png',
    description:
      'Клоунада - это жанр комедийного театра, в котором актеры используют физические выразительные средства, такие как мимика, жесты, телодвижения, звуковые эффекты и импровизация, чтобы создать комические ситуации и взаимодействовать с аудиторией. Цель театральной клоунады - развлечь зрителей, вызвать у них смех и эмоциональные реакции, а также поразмышлять о жизни и человеческих отношениях через призму комических ситуаций, создаваемых клоунами на сцене.',
    lesson_duration: '1,5 час',
    skills: [
...

  {
    ...
    ImageURLResize: resize.resize,
    description:
      'Актёрское искусство — профессиональная творческая деятельность в области исполнительских искусств, состоящая в создании сценических образов, вид исполнительского творчества. Исполняя определённую роль в театральном представлении, актёр как бы уподобляет себя лицу, от имени которого он действует в спектакле.',
    lesson_duration: '1,5 часа',
    cost: [
      {
