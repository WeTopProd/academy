...
export const teacherSeed: ITeacher[] = [
  {
    ...
    greetings:
      'Всем привет! Я преподаватель актерского мастерства, театральной клоунады и танца степ (чечетка епты) в творческой академии Француз. На своем веку снялся более чем в 100 кинокартинах и 50 театральных постановок таких как: Подсудимый, Лихач, Условный мент, Тайны следствия, Аврора, Чистосердечное призвание-3, Два холма – 2 и др.',
    unique:
      'На курсе вы будете участвовать в практических занятиях, импровизациях и получать профессиональные знания и опыт',
    future: [
  ...
  },
  {
    ...
    greetings:
      'Здравствуйте, меня зовут Срджан, я актер театра и кино, преподаю актерское мастерство и сценическую речь, а также пантомиму в творческой академии Француз и НИУ ВШЭ. Снимался в короткометражных фильмах, таких как: «Гоголь – последние дни», «Золотой Витязь», «Сон смешного человека», «Спасая Комитаса» и др.',
    unique:
      'На курсе вы будете участвовать в практических занятиях, импровизациях и получать профессиональные знания и опыт',
    future: [
      'Снимите телесные и речевые зажимы, психологические блоки и неуверенность перед публикой',
  ...
  },
  {
    ...
    greetings:
      'Всем здравствуйте! Меня зовут Иван, я, преподаватель школы ведущих, актерского мастерства и сценической речи в творческой академии «Француз». Являюсь действующим актером и снялся уже более чем в 50 эпизодах кино и сериалов таких как: Песнь бездны, Молодые и сильные выживут, Господство, SASPENC и др.',
    unique:
      'На курсе вы будете участвовать в практических занятиях, импровизациях и получать профессиональные знания и опыт',
    future: [
      'Снимите телесные и речевые зажимы, психологические блоки и неуверенность перед публикой',
  ...
  },
  {
    ...
    greetings:
      'Всем привет! Я преподаватель актерского мастерства, театральной клоунады и танца степ (чечетка епты) в творческой академии Француз. На своем веку снялся более чем в 100 кинокартинах и 50 театральных постановок таких как: Подсудимый, Лихач, Условный мент, Тайны следствия, Аврора, Чистосердечное призвание-3, Два холма – 2 и др.',
    unique:
      'Во время каждого занятия, Вам будет предоставлена возможность выйти на сцену и проявить свое творчество в режиме реального времени.',
    future: [
      'Снимите телесные и речевые зажимы, психологические блоки и неуверенность перед публикой',
      'Разовьете наблюдательность, внимание и память',
      'Научитесь работать в режиме импровизации и разовьете эмоциональный самоконтроль',
  ...
  },
  {
    ...
    greetings:
      'Всем привет! Я - ваш преподаватель по вокалу. Здесь, на наших уроках, мы будем исследовать и раскрывать ваше вокальное мастерство, развивать вашу уверенность на сцене и научимся выражать эмоции через музыку. Моя цель - помочь вам раскрыть ваш потенциал и достичь новых высот в вашем вокальном искусстве. Будет много интересных задач, творческих испытаний и вдохновляющих моментов на наших уроках.',
    unique:
      'Получите возможность развивать свой голос и музыкальные навыки осваивая различные стили и техники вокального искусства.',
    future: [
